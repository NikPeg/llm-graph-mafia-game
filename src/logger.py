...
class GameLogger:
    ...
    def player_setup(self, player_name, role, player_display_name=None, rag_info=""):
        """
        Log player setup.
        ...
        Args:
            ...
            rag_info (str, optional): RAG information for the player.
        """
        ...
        self.print(f"Role: {role}{rag_info}", role_color, bold=True)
